...
### 7.0 Conclusion
It is evident from the result, the random forest algorithm performs better than the decision tree in terms of accuracy. We are getting 99.25% in sample accuracy, while the decision tree gives us only nearly 48.59% in sample accuracy
